                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="name" value="{{old('name')}}" required autofocus name="name" placeholder="Username" />
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                <input required=""  id="password"  type="password" name="password" required autocomplete="new-password" placeholder="Password" />
                                                @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
